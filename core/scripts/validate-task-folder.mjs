...
// этапа»): в docs/specs/tasks/<FE|BE>/<TASK-ID>/ живут ТОЛЬКО артефакты
// конвейера (*.md, meta.json). Исходники (tsx/js/less/…) — признак того, что
// агент перепутал папку задачи с рабочей копией кодовой базы.
//
// Использование:
