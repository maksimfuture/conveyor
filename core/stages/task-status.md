...
репозитории НЕ трогает: данные — только `docs/specs/tasks/*/*/meta.json`,
список папок `intents/*/` и наличие файлов-артефактов. Работает без
заполненного `.env`.
...
2. Прочитай `docs/specs/tasks/FE/*/meta.json` и
   `docs/specs/tasks/BE/*/meta.json`, а также список папок `intents/*/`.
